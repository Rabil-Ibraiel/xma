...
import { editPartyRegion, getAllParties } from "../actions/getParties";
...
const iraqRegions = {
  "IQ-BA": "البصرة", // البصرة
  "IQ-AN": "الأنبار", // الأنبار
  "IQ-DI": "ديالى", // ديالى
  "IQ-SU": "السليمانية", // السليمانية
  "IQ-WA": "واسط", // واسط
  "IQ-MU": "المثنى", // المثنى
  "IQ-KA": "كربلاء", // كربلاء
  "IQ-MA": "ميسان", // ميسان
  "IQ-NA": "النجف", // النجف
  "IQ-QA": "القادسية", // القادسية
  "IQ-BB": "بابل", // بابل
  "IQ-BG": "بغداد", // بغداد
  "IQ-DA": "دهوك", // ذي قار
  "IQ-DQ": "ذي قار", // دهوك
  "IQ-NI": "نينوى", // نينوى
  "IQ-SD": "صلاح الدين", // صلاح الدين
  "IQ-KI": "كركوك", // كركوك
  "IQ-AR": "أربيل",
};
...
export default function RegionBasedParty() {
  ...
  const updateAction = async (formData) => {
    ...
    await editPartyRegion(formData);
...
<label className="min-w-24">المحافظة:</label>
<select
  dir="rtl"
  name="regionCode"
  required
  className="border py-1 px-2 mr-1 w-40 text-lg"
  defaultValue=""             // ⬅️ this replaces selected on <option>
>
  <option value="" disabled>اختر المحافظة</option>
  <option value="IQ-BA">البصرة</option>
  <option value="IQ-AN">الأنبار</option>
  <option value="IQ-DI">ديالى</option>
  <option value="IQ-SU">السليمانية</option>
  <option value="IQ-WA">واسط</option>
  <option value="IQ-MU">المثنى</option>
  <option value="IQ-KA">كربلاء</option>
  <option value="IQ-MA">ميسان</option>
  <option value="IQ-NA">النجف</option>
  <option value="IQ-QA">القادسية</option>
  <option value="IQ-BB">بابل</option>
  <option value="IQ-BG">بغداد</option>
  <option value="IQ-DA">دهوك</option>
  <option value="IQ-DQ">ذي قار</option>
  <option value="IQ-NI">نينوى</option>
  <option value="IQ-SD">صلاح الدين</option>
  <option value="IQ-KI">كركوك</option>
  <option value="IQ-AR">أربيل</option>
</select>
            </div>
